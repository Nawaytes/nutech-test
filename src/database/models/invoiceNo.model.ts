...
export interface InvoiceNoInterface extends Required<InvoiceNoAttributes> {}

class InvoiceNo
  extends BaseModel<InvoiceNoAttributes, InvoiceNoCreationAttributes>
...
InvoiceNo.init(
  ...
  { ...baseModelConfig, tableName: "invoice_no" }
);
